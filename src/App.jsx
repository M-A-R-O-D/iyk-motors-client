...
function App() {
  ...
  return (
    <>
     <nav className='Navbar w-full bg-white h-[70px]  flex flex-row items-center justify-between px-2.5 py-2.5 fixed z-10'>
      <div className='logo'>
  ...
  <div className="search-bars flex ">
    ...
    <button className='btn w-48 h-14 m-4 bg-[#0e5a9f] text-white bebas-neue'>SEARCH</button>
      ...
      <section>
      <footer className='w-full h-auto bg-[rgb(14,90,159)] flex flex-col items-center'>
    <div className='flex items-center justify-center'>
        <p className='font-bold text-[35px] text-white mt-8 '>IY-KAY MOTORS</p>
    </div>
    <div className='w-full flex justify-center'>
        <ul className='flex justify-between'>
            <li className='mr-9'>
                <a href="" className='font-semibold text-[15px] mr-9 text-white decoration-2 decoration-[#1e7ed7] hover:underline' style={{ textUnderlineOffset: '15px' }}>HOME</a>
                <a href="" className='font-semibold text-[15px] mr-9 text-white decoration-2 decoration-[#1e7ed7] hover:underline' style={{ textUnderlineOffset: '15px' }}>CARS</a>
                <a href="" className='font-semibold text-[15px] mr-9 text-white decoration-2 decoration-[#1e7ed7] hover:underline' style={{ textUnderlineOffset: '15px' }}>ABOUT US</a>
                <a href="" className='font-semibold text-[15px] mr-9 text-white decoration-2 decoration-[#1e7ed7] hover:underline' style={{ textUnderlineOffset: '15px' }}>OUR BLOG</a>
            </li>
        </ul>
    </div>
      <hr className='m-[10.5px] w-[1080px]'/>
      <div className='ml-auto flex'>
       <div className='m-8'>
       <p className='font-semibold text-white'>CONTACT US:</p>
        <p className='text-white'>+233 59 8285 85</p>
        <p className='text-white'>Achimota-Mile 7(opposite fidelity bank)</p>
       </div>

        <div className="socials m-8" >
