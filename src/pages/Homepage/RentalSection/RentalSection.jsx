...
function RentalSection() {
  ...
  return (
    <div id="rentals-section" className="rental-section h-auto flex flex-col md:h-110 md:flex-row items-center space-y-10 md:space-y-0 md:space-x-10 p-6 md:p-10 bg-custom-white">
